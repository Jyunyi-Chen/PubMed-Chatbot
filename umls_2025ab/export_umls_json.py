...
if __name__ == "__main__":
    ...
    parser.add_argument("--meta_path", help="Path to the META directory of an UMLS release.")
    parser.add_argument("--output_path", help="Path to the output jsonl file.")
    parser.add_argument("--lang", default="ENG", help="Language subset of UMLS.")
    parser.add_argument("--source", type=str, default=None, help="Whether to filter for a only a single UMLS source.")
    parser.add_argument("--non_suppressed", default=True, help="Whether to include non-suppressed terms.")
